...
V120_QUALITY_TEXT_FIELDS = [
    "主推薦資格", "V125推薦層級", "V125推薦層級排序", "股神主推薦狀態", "V125股神實戰建議", "V125主推薦說明", "主推薦不合格原因", "實戰分區", "實戰排除原因", "V122股神實戰建議", "V123推薦層級", "V123推薦層級排序", "V123股神實戰建議",
    "量能狀態", "趨勢狀態", "實戰品質提醒",
]
V120_QUALITY_COLUMNS = V120_QUALITY_NUMERIC_FIELDS + V120_QUALITY_TEXT_FIELDS
V120_QUALITY_DISPLAY_COLS = [
    "推薦日期", "股票代號", "股票名稱", "主推薦資格", "V125推薦層級", "V125推薦層級排序", "股神主推薦狀態", "V125股神實戰建議", "V125主推薦說明", "主推薦排序分", "實戰主推薦分", "主推薦不合格原因", "推薦總分", "夜間股神總分", "隔日進場分數",
