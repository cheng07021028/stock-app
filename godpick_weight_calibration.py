...
QUALITY_DISPLAY_COLUMNS: List[str] = [
    "股票代號", "股票名稱", "推薦日期", "推薦時間",
    "主推薦資格", "V125推薦層級", "原始推薦總分", "實戰調整推薦分", "V126實戰排序分", "V125推薦層級排序", "股神主推薦狀態", "V125股神實戰建議", "V125主推薦說明", "V126實戰排序分", "主推薦排序分", "實戰主推薦分", "主推薦不合格原因", "實戰品質分", "量能狀態", "趨勢狀態", "實戰降分", "實戰品質提醒",
