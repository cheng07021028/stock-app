...
QUALITY_SCORE_COLUMNS: Dict[str, List[str]] = {
    "技術結構": ["V126實戰排序分", "主推薦排序分", "實戰主推薦分", "實戰品質分", "均線轉強分", "動能翻多分", "收盤距MA20%", "收盤距MA60%"],
    "交易可行": ["V126實戰排序分", "主推薦排序分", "實戰主推薦分", "實戰品質分", "支撐防守分", "量能啟動分"],
...
QUALITY_GROUP_COLUMNS: List[str] = [
    "V129顯示分區", "V129主要表顯示", "V129精簡輸出排序", "V129冷門觀察區", "V129輸出限制原因", "V129股神輸出建議", "V129精簡輸出版", "主推薦資格", "V127推薦層級", "V127候補等級", "V127推薦層級排序", "V127候補排序分", "V127候補限制原因", "V127冷門股壓後", "V127股神實戰建議", "V127主推薦說明", "實戰品質級距", "量能狀態", "趨勢狀態", "實戰降分級距",
...
QUALITY_DISPLAY_COLUMNS: List[str] = [
    "股票代號", "股票名稱", "推薦日期", "推薦時間",
    "V129顯示分區", "V129主要表顯示", "V129精簡輸出排序", "V129冷門觀察區", "V129輸出限制原因", "V129股神輸出建議", "V129精簡輸出版", "主推薦資格", "V127推薦層級", "V127候補等級", "V127推薦層級排序", "V127候補排序分", "V127候補限制原因", "V127冷門股壓後", "V127股神實戰建議", "V127主推薦說明", "V125推薦層級", "原始推薦總分", "實戰調整推薦分", "V126實戰排序分", "V125推薦層級排序", "股神主推薦狀態", "V125股神實戰建議", "V125主推薦說明", "V126實戰排序分", "主推薦排序分", "實戰主推薦分", "主推薦不合格原因", "實戰品質分", "量能狀態", "趨勢狀態", "實戰降分", "實戰品質提醒",
