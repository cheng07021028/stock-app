...
# v136：實戰品質防呆欄位納入 14 權重校正，但分析只讀統一有效欄位，不再讀 V127~V134 版本欄位。
QUALITY_SCORE_COLUMNS: Dict[str, List[str]] = {
    "技術結構": ["股神輸出排序", "候補排序分", "實戰調整推薦分", "實戰品質分", "均線轉強分", "動能翻多分", "收盤距MA20%", "收盤距MA60%"],
    "交易可行": ["股神輸出排序", "候補排序分", "實戰品質分", "支撐防守分", "量能啟動分", "交易可行分數"],
    "爆發力": ["量能啟動分", "均量比", "突破準備分", "實戰品質分", "成交額百萬", "20日均成交額百萬"],
    "型態突破": ["突破準備分", "均線轉強分", "動能翻多分", "支撐防守分"],
    "類股熱度": ["資金流熱門族群", "族群熱度排名", "族群資金流分數", "族群流動性分數"],
    "自動因子": ["實戰品質分", "官方因子總分", "官方資料完整度"],
}

QUALITY_GROUP_COLUMNS: List[str] = [
    "股神推薦層級", "候補等級", "是否主要顯示", "主表篩選", "股神輸出排序", "候補排序分",
    "股神實戰建議", "限制原因", "族群名稱", "資金流熱門族群", "族群熱度排名", "族群資金流分數",
    "族群流動性分數", "族群樣本數", "族群判斷依據", "大盤趨勢模式", "成交額百萬", "20日均成交額百萬", "流動性等級",
