...
def main():
    ...
    assert TRUTH_VERSION == "godpick_t1_trade_truth_v191_h73_leadership_breadth_distribution_truth_20260916"
    ...
    assert 'PAGE07_SPEED_FIX_VERSION = "page07_v191_h73_leadership_breadth_distribution_truth_20260916"' in page
