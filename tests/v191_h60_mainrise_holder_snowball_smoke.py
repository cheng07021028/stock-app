...
def main():
    ...
    assert TRUTH_VERSION == "godpick_t1_trade_truth_v191_h72_multi_model_alpha_ensemble_20260915"
    ...
    assert 'PAGE07_SPEED_FIX_VERSION = "page07_v191_h72_multi_model_alpha_ensemble_20260915"' in page
