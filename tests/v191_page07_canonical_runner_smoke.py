...
h62_action_df=pd.DataFrame([
    {'股票代號':'1111','股票名稱':'熟面孔Formal','正式推薦分區':'正式下週主推薦','盤中雷達優先級':'','H62版本':ns['H62_OPPORTUNITY_VERSION'],'H62有效權威':'FORMAL-HOLD','H64版本':ns['H64_CORE_VERSION'],'H64有效權威':'FORMAL-HOLD'},
    {'股票代號':'2222','股票名稱':'健康Formal','正式推薦分區':'正式下週主推薦','盤中雷達優先級':'','H62版本':ns['H62_OPPORTUNITY_VERSION'],'H62有效權威':'EFFECTIVE-FORMAL','H64版本':ns['H64_CORE_VERSION'],'H64有效權威':'EFFECTIVE-FORMAL'},
    {'股票代號':'3333','股票名稱':'Aminus','正式推薦分區':'A-｜準主推薦小量試單','盤中雷達優先級':'','H62版本':ns['H62_OPPORTUNITY_VERSION'],'H62有效權威':'A-MINUS','H64版本':ns['H64_CORE_VERSION'],'H64有效權威':'A-MINUS'},
])
...
print('PASS H62/H64 persistence guard excludes held Formal from Page08/Page10 current action path')
