...
def main():
    ...
    assert 'PAGE07_SPEED_FIX_VERSION = "page07_v191_h62_incremental_opportunity_effective_formal_truth_20260907"' in page_text
    assert "超級AI唯一決策｜H62 有效Formal×全市場增量機會×熟面孔淘汰" in page_text
