...
def main():
    assert VERSION == "v191_h54_continuation_exhaustion_overnight_truth_20260831"
    ...
    assert "H54判定" in str(weekend_final.iloc[0].get("狀態", ""))
    ...
    assert 'H51_HUMAN_MASTER_EXPECTED_VERSION = "v191_h54_continuation_exhaustion_overnight_truth_20260831"' in page_text
    assert 'PAGE07_SPEED_FIX_VERSION = "page07_v191_h54_continuation_exhaustion_overnight_truth_20260831"' in page_text
    assert "H54隔日真相升級" in page_text
