...
def main():
    ...
    assert TRUTH_VERSION == "godpick_t1_trade_truth_v191_h70_counter_regime_session_truth_20260914"
    ...
    assert 'PAGE07_SPEED_FIX_VERSION = "page07_v191_h70_counter_regime_session_truth_20260914"' in page
