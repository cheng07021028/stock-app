...
UNIFIED_RECOMMEND_DISPLAY_COLUMNS = [
    ...
    "觸發後收盤績效%", "可執行交易1日%", "可執行交易3日%", "可執行交易5日%", "可執行交易10日%", "可執行交易20日%",
...
NUMERIC_LIKE_COLUMNS = {
    ...
    "可執行交易1日%", "可執行交易3日%", "可執行交易5日%", "可執行交易10日%", "可執行交易20日%",
    "可執行交易最大漲幅%", "可執行交易最大回撤%", "還原價格調整係數", "3日績效%", "5日績效%", "10日績效%", "20日績效%", "主流資金分", "資金攻擊有效分", "族群廣度分", "族群成交額分", "大盤資料落後交易日", "飆股適合度", "今日可追強度", "中小型股風險", "族群輪動分", "族群攻擊強度", "族群續航力", "法人攻擊分", "投信鎖碼分", "主力點火分", "大戶承接分", "籌碼續航分", "飆股攻擊分", "隔日大漲機率分", "盤中轉強觸發價", "爆發雷達分", "隔日爆發分", "局部題材火種分", "漏網回補分", "市場領漲相似分", "漲停族群相似度", "主流領漲回補分", "漲停回放分", "強勢股漏選風險分", "觸發後守價",
}
...
EXPORT_ALWAYS_KEEP_COLUMNS = {
    ...
    "股神同步分區", "股神同步說明",
    "股神實戰總分", "股神推薦優先分", "股神推薦總排名", "股神推薦等級", "股神推薦用途", "股神推薦分數說明", "主流主升優先分", "主流主升判定", "主流主升操作限制", "Alpha選股潛力分", "Entry進場買點分", "Risk風控安全分", "Feedback績效校正分",
