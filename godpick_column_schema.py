...
UNIFIED_RECOMMEND_DISPLAY_COLUMNS = [
    ...
    "推薦模式", "推薦型態", "機會型態", "推薦等級", "推薦總分", "候選強度分", "精選TopN排名", "精選輸出分區", "精選輸出資格", "精選輸出原因", "使用者推薦總分下限", "使用者輸出TopN", "精選輸出版本", "股神實戰總分", "Alpha選股潛力分", "Entry進場買點分", "Risk風控安全分", "Feedback績效校正分", "選股潛力分", "進場買點分", "風控安全分", "績效校正分", "新買點分級", "推薦角色", "正式推薦分區", "正式推薦資格", "可操作分", "下週是否可直接買", "正式推薦動作", "盤中雷達等級", "盤中雷達動作", "正式推薦排除原因", "正式推薦排序分", "正式推薦版本", "下週作戰分區", "下週作戰說明", "下週操作動作", "下週是否可進攻", "下週作戰版本", "大盤攻擊模式", "主流資金分", "資金攻擊有效分", "飆股適合度", "今日可追強度", "中小型股風險", "今日大盤結論", "大盤風險燈號", "族群輪動分", "族群攻擊強度", "族群續航力", "族群內領頭羊", "族群內補漲股", "資金輪動角色", "族群攻擊說明", "法人攻擊分", "投信鎖碼分", "主力點火分", "大戶承接分", "籌碼續航分", "資金攻擊摘要", "主流資金分", "資金攻擊有效分", "成交額等級", "冷門股警示", "主流股判定", "資金攻擊有效性", "主流資金角色", "主流資金說明", "主流作戰分區", "主流作戰說明", "主流操作動作", "飆股攻擊分", "隔日大漲機率分", "漲停獵人觀察", "飆股獵人角色", "盤中轉強觸發價", "追漲許可", "攻擊候選原因", "爆發雷達分", "隔日爆發分", "局部題材火種分", "漏網回補分", "飆股雷達角色", "飆股雷達分區", "盤中點火條件", "飆股雷達原因", "飆股雷達風險", "市場領漲相似分", "漲停族群相似度", "主流領漲回補分", "錯失飆股警示", "錯失原因診斷", "領漲回補角色", "領漲回補分區", "隔夜催化需求", "市場領漲檢討版本", "漲停回放分", "強勢股漏選風險分", "候選池覆蓋診斷", "漲停漏選原因", "漏選原因分類", "漏選修正動作", "回放校正角色", "回放校正分區", "回放校正版本", "雙引擎決策", "穩健推薦角色", "推薦分數", "推薦用途", "買進分數", "是否可直接買進", "盤中確認條件", "專業決策摘要", "決策版本", '股神輸出排序', '候補排序分', '族群熱度排名', '族群資金流分數', '族群流動性分數', '族群樣本數', '人氣量能分', '成交額百萬', '20日均成交額百萬', '最新成交量_張', '20日均量_張', '近5日漲幅%', '近20日漲幅%', "股神決策分數",
...
NUMERIC_LIKE_COLUMNS = {
    "推薦總分", "推薦分數", "精選TopN排名", "使用者推薦總分下限", "使用者輸出TopN", "股神實戰總分", "Alpha選股潛力分", "Entry進場買點分", "Risk風控安全分", "Feedback績效校正分", "選股潛力分", "進場買點分", "風控安全分", "績效校正分", "績效樣本數", "買進分數", '股神輸出排序', '候補排序分', '族群熱度排名', '族群資金流分數', '族群流動性分數', '族群樣本數', '人氣量能分', '成交額百萬', '20日均成交額百萬', '最新成交量_張', '20日均量_張', '近5日漲幅%', '近20日漲幅%', "股神決策分數", "可操作分", "正式推薦排序分", "夜間股神總分", "隔日實戰排序分", "隔日進場分數", "波段潛力分數",
    ...
    "推薦後1日%", "推薦後3日%", "推薦後5日%", "推薦後10日%", "推薦後20日%", "推薦後最大漲幅%", "推薦後最大回撤%", "即時追蹤報酬%", "3日績效%", "5日績效%", "10日績效%", "20日績效%", "主流資金分", "資金攻擊有效分", "飆股適合度", "今日可追強度", "中小型股風險", "族群輪動分", "族群攻擊強度", "族群續航力", "法人攻擊分", "投信鎖碼分", "主力點火分", "大戶承接分", "籌碼續航分", "飆股攻擊分", "隔日大漲機率分", "盤中轉強觸發價", "爆發雷達分", "隔日爆發分", "局部題材火種分", "漏網回補分", "市場領漲相似分", "漲停族群相似度", "主流領漲回補分", "漲停回放分", "強勢股漏選風險分",
}
...
EXPORT_ALWAYS_KEEP_COLUMNS = {
    ...
    "推薦角色", "下週作戰分區", "下週作戰說明", "下週操作動作", "下週是否可進攻", "飆股獵人角色", "飆股攻擊分", "隔日大漲機率分", "漲停回放分", "強勢股漏選風險分", "回放校正角色", "回放校正分區", "建議動作", "建議倉位", "建議倉位%",
