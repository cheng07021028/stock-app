...
UNIFIED_RECOMMEND_DISPLAY_COLUMNS = [
    ...
    "主要進場路徑", "主要進場參考價", "回測承接參考價", "突破確認參考價", "進場績效計算口徑",
