...
UNIFIED_RECOMMEND_DISPLAY_COLUMNS = [
    ...
    "觸發後收盤績效%", "觸發當日收盤績效%", "觸發當日最高報酬%", "觸發當日最大回撤%", "隔日候選漲跌%", "隔日執行命中結果", "隔日績效檢討標籤", "未觸發漏選標記", "候選與交易分流說明", "績效更新版本", "可執行交易1日%", "可執行交易3日%", "可執行交易5日%", "可執行交易10日%", "可執行交易20日%",
...
GODPICK_RECORD_TRACE_COLUMNS = [
    ...
    "主流主升優先分", "主流主升判定", "主流主升操作限制", "隔日觸發品質分", "隔日觸發品質判定", "主流資金分",
...
EXPORT_ALWAYS_KEEP_COLUMNS = {
    ...
    "股神同步分區", "股神同步說明",
    "股神實戰總分", "股神推薦優先分", "股神推薦總排名", "股神推薦等級", "股神推薦用途", "股神推薦分數說明", "主流主升優先分", "主流主升判定", "主流主升操作限制", "隔日觸發品質分", "隔日觸發品質判定", "Alpha選股潛力分", "Entry進場買點分", "Risk風控安全分", "Feedback績效校正分",
