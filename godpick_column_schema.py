...
UNIFIED_RECOMMEND_DISPLAY_COLUMNS = [
    ...
    "推薦模式", "推薦型態", "機會型態", "推薦等級", "主推薦資格", "V125推薦層級", "V125推薦層級排序", "股神主推薦狀態", "V125股神實戰建議", "V125主推薦說明", "主推薦排序分", "實戰主推薦分", "主推薦不合格原因", "實戰分區", "實戰排除原因", "V122股神實戰建議", "V123推薦層級", "V123推薦層級排序", "V123股神實戰建議", "推薦總分", "推薦分數", "股神決策分數",
...
NUMERIC_LIKE_COLUMNS = {
    "主推薦排序分", "實戰主推薦分", "實戰品質分", "實戰降分", "最新成交量", "5日均量", "20日均量", "均量比", "收盤距MA20%", "收盤距MA60%",
