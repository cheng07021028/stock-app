...
NUMERIC_LIKE_COLUMNS = {
    ...
    "推薦後1日%", "推薦後3日%", "推薦後5日%", "推薦後10日%", "推薦後20日%", "推薦後最大漲幅%", "推薦後最大回撤%", "即時追蹤報酬%", "3日績效%", "5日績效%", "10日績效%", "20日績效%", "主流資金分", "資金攻擊有效分", "飆股適合度", "今日可追強度", "中小型股風險", "族群輪動分", "族群攻擊強度", "族群續航力", "法人攻擊分", "投信鎖碼分", "主力點火分", "大戶承接分", "籌碼續航分", "飆股攻擊分", "隔日大漲機率分", "盤中轉強觸發價", "爆發雷達分", "隔日爆發分", "局部題材火種分", "漏網回補分",
}
...
EXPORT_ALWAYS_KEEP_COLUMNS = {
    ...
    "股神實戰總分", "Alpha選股潛力分", "Entry進場買點分", "Risk風控安全分", "Feedback績效校正分",
    "推薦角色", "下週作戰分區", "下週作戰說明", "下週操作動作", "下週是否可進攻", "飆股獵人角色", "飆股攻擊分", "隔日大漲機率分", "建議動作", "建議倉位", "建議倉位%",
    "盤中轉強觸發價", "加碼條件", "失效條件", "風險報酬比", "停損價", "突破確認價", "近端支撐", "近端壓力",
    "大盤攻擊模式", "今日大盤結論", "族群攻擊強度", "資金輪動角色", "籌碼續航分", "主流資金分", "資金攻擊有效分", "主流股判定", "冷門股警示", "主流作戰分區", "推薦理由摘要",
}
