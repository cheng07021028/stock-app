...
NUMERIC_LIKE_COLUMNS = {
    ...
    "推薦後1日%", "推薦後3日%", "推薦後5日%", "推薦後10日%", "推薦後20日%", "推薦後最大漲幅%", "推薦後最大回撤%", "即時追蹤報酬%", "3日績效%", "5日績效%", "10日績效%", "20日績效%", "主流資金分", "資金攻擊有效分", "飆股適合度", "今日可追強度", "中小型股風險", "族群輪動分", "族群攻擊強度", "族群續航力", "法人攻擊分", "投信鎖碼分", "主力點火分", "大戶承接分", "籌碼續航分", "飆股攻擊分", "隔日大漲機率分", "盤中轉強觸發價", "爆發雷達分", "隔日爆發分", "局部題材火種分", "漏網回補分", "市場領漲相似分", "漲停族群相似度", "主流領漲回補分",
}
