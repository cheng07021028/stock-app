...
UNIFIED_RECOMMEND_DISPLAY_COLUMNS = [
    ...
    "推薦模式", "推薦型態", "機會型態", "推薦等級", "推薦總分", "股神實戰總分", "選股潛力分", "進場買點分", "風控安全分", "績效校正分", "新買點分級", "推薦角色", "推薦分數", "推薦用途", "買進分數", "是否可直接買進", "盤中確認條件", "專業決策摘要", '股神輸出排序', '候補排序分', '族群熱度排名', '族群資金流分數', '族群流動性分數', '族群樣本數', '人氣量能分', '成交額百萬', '20日均成交額百萬', '最新成交量_張', '20日均量_張', '近5日漲幅%', '近20日漲幅%', "股神決策分數",
    ...
    "風險說明", "績效校正說明", "績效回饋建議", "過熱原因", "小量試單建議", "加碼條件", "失效條件_績效回饋", "績效樣本數", "績效回饋版本", "股神推論", "股神推論邏輯", "推薦理由", "推薦原因", "推薦理由摘要", "推薦標籤", "備註",
...
ALIASES: dict[str, list[str]] = {
    ...
    "選股潛力分": ["技術結構分數", "股神輸出排序"],
    "進場買點分": ["買進分數", "實戰買點分數", "隔日進場分數"],
    "風控安全分": ["實戰品質分", "交易可行分數"],
    "績效校正分": ["績效回饋分"],
    "新買點分級": ["買點分級"],
    "推薦角色": ["股神推薦層級", "推薦用途"],
    "績效回饋建議": ["股神實戰建議", "專業決策摘要"],
...
NUMERIC_LIKE_COLUMNS = {
    "推薦總分", "推薦分數", "股神實戰總分", "選股潛力分", "進場買點分", "風控安全分", "績效校正分", "績效樣本數", "買進分數", '股神輸出排序', '候補排序分', '族群熱度排名', '族群資金流分數', '族群流動性分數', '族群樣本數', '人氣量能分', '成交額百萬', '20日均成交額百萬', '最新成交量_張', '20日均量_張', '近5日漲幅%', '近20日漲幅%', "股神決策分數", "夜間股神總分", "隔日實戰排序分", "隔日進場分數", "波段潛力分數",
