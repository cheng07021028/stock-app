...
EXPORT_ALWAYS_KEEP_COLUMNS = {
    ...
    "推薦角色", "飆股獵人角色", "飆股攻擊分", "隔日大漲機率分", "建議動作", "建議倉位", "建議倉位%",
