...
NUMERIC_LIKE_COLUMNS = {
    "推薦總分", "推薦分數", "股神實戰總分", "股神推薦優先分", "股神推薦總排名", "今日訊號新鮮分", "近5次入榜次數", "連續入榜次數", "前次推薦排名", "前次推薦優先分", "本次分數變化", "重複推薦校正分", "股神推薦優先分_輪動前", "主流主升優先分", "Alpha選股潛力分", "Entry進場買點分", "Risk風控安全分", "Feedback績效校正分", "選股潛力分", "進場買點分", "風控安全分", "績效校正分", "績效樣本數", "買進分數", '股神輸出排序', '候補排序分', '族群熱度排名', '族群資金流分數', '族群流動性分數', '族群樣本數', '人氣量能分', '成交額百萬', '20日均成交額百萬', '最新成交量_張', '20日均量_張', '近5日漲幅%', '近20日漲幅%', "股神決策分數", "推薦可信度分", "建議倉位上限%", "倉位折減係數", "掃描覆蓋率%", "有效K線資料率%", "歷史資料成功率%", "流動性資料覆蓋率%", "官方因子覆蓋率%", "可操作分", "正式推薦排序分", "股神作戰優先序", "夜間股神總分", "隔日實戰排序分", "隔日進場分數", "波段潛力分數",
