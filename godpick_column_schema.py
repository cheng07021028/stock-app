...
UNIFIED_RECOMMEND_DISPLAY_COLUMNS = [
    ...
    "推薦模式", "推薦型態", "機會型態", "推薦等級", "推薦總分", "推薦分數", "推薦用途", "買進分數", "是否可直接買進", "盤中確認條件", "專業決策摘要", '股神輸出排序', '候補排序分', '族群熱度排名', '族群資金流分數', '族群流動性分數', '族群樣本數', '人氣量能分', '成交額百萬', '20日均成交額百萬', '最新成交量_張', '20日均量_張', '近5日漲幅%', '近20日漲幅%', "股神決策分數",
...
NUMERIC_LIKE_COLUMNS = {
    "推薦總分", "推薦分數", "買進分數", '股神輸出排序', '候補排序分', '族群熱度排名', '族群資金流分數', '族群流動性分數', '族群樣本數', '人氣量能分', '成交額百萬', '20日均成交額百萬', '最新成交量_張', '20日均量_張', '近5日漲幅%', '近20日漲幅%', "股神決策分數", "夜間股神總分", "隔日實戰排序分", "隔日進場分數", "波段潛力分數",
