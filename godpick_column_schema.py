...
UNIFIED_RECOMMEND_DISPLAY_COLUMNS = [
    ...
    "推薦日期", "推薦時間", "推薦批次日期", "推薦批次時間", "推薦執行ID", "推薦執行來源", "推薦觸發方式", "推薦執行版本", "原始推薦日期", "股票代號", "股票名稱", "市場別", "類別", "產業",
    ...
    "進場觸發狀態", "進場觸發日期", "進場評估路徑", "是否納入可執行績效", "理論進場參考價", "執行基準價", "執行價來源", "執行價可成交驗證", "觸發訊號品質分",
...
NUMERIC_LIKE_COLUMNS = {
    ...
    "推薦後1日%", "推薦後3日%", "推薦後5日%", "推薦後10日%", "推薦後20日%", "推薦後最大漲幅%", "推薦後最大回撤%", "即時追蹤報酬%",
    "隔日耗竭風險分", "隔日可執行優先分", "恐慌反彈領漲分", "理論進場參考價", "執行基準價", "觸發訊號品質分", "觸發後收盤績效%",
    "可執行交易1日%", "可執行交易3日%", "可執行交易5日%", "可執行交易10日%", "可執行交易20日%",
...
EXPORT_ALWAYS_KEEP_COLUMNS = {
    ...
    "勾選", "推薦日期", "推薦時間", "推薦批次日期", "推薦批次時間", "推薦執行ID", "推薦執行來源", "推薦觸發方式", "推薦執行版本", "原始推薦日期", "股票代號", "股票名稱", "市場別", "類別", "產業", "最新價", "推薦總分", "候選強度分",
    "股神同步分區", "股神同步說明",
    ...
    "盤中轉強觸發價", "加碼條件", "失效條件", "風險報酬比", "停損價", "突破確認價", "近端支撐", "近端壓力", "理論進場參考價", "執行基準價", "執行價來源", "執行價可成交驗證",
