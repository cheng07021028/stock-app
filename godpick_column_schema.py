...
EXPORT_ALWAYS_KEEP_COLUMNS = {
    ...
    "大盤攻擊模式", "今日大盤結論", "大盤風控層級", "大盤資料日期", "大盤資料落後交易日", "大盤資料新鮮度", "大盤原始橋接狀態", "族群輪動分", "族群攻擊強度", "族群廣度分", "族群成交額分", "族群主升確認", "資金輪動角色", "籌碼續航分", "主流資金分", "資金攻擊有效分", "主流股判定", "冷門股警示", "主流作戰分區", "推薦理由摘要",
}
