...
UNIFIED_RECOMMEND_DISPLAY_COLUMNS = [
    ...
    "推薦模式", "推薦型態", "機會型態", "推薦等級", "推薦總分", "股神實戰總分", "Alpha選股潛力分", "Entry進場買點分", "Risk風控安全分", "Feedback績效校正分", "選股潛力分", "進場買點分", "風控安全分", "績效校正分", "新買點分級", "推薦角色", "推薦分數", "推薦用途", "買進分數", "是否可直接買進", "盤中確認條件", "專業決策摘要", "決策版本", '股神輸出排序', '候補排序分', '族群熱度排名', '族群資金流分數', '族群流動性分數', '族群樣本數', '人氣量能分', '成交額百萬', '20日均成交額百萬', '最新成交量_張', '20日均量_張', '近5日漲幅%', '近20日漲幅%', "股神決策分數",
    ...
    "風險說明", "績效校正說明", "績效回饋建議", "過熱原因", "硬否決原因", "實戰過濾狀態", "主推薦降級原因", "冷卻提示", "小量試單建議", "加碼條件", "失效條件", "失效條件_績效回饋", "績效樣本數", "績效回饋版本", "決策版本", "股神推論", "股神推論邏輯", "推薦理由", "推薦原因", "推薦理由摘要", "推薦標籤", "備註",
